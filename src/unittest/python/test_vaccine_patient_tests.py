...
class TestVaccinePatient(TestCase):
    ...
    def setUp(self):
        ...
        my_manager.request_vaccination_id("57c811e5-3f5a-4a89-bbb8-11c0464d53e6",
                                          ...
                                          "+34333456789","7")
        file_test = JSON_FILES_TESTS_PATH + "test_ok_2.json"
    ...
    def test_vaccine_patient_ok(self):
        ...
        ruta = JSON_FILES_PATH + "store_date.json"
        ...
        data_list = [{
            ...
            "_VaccinationAppointment__patient_sys_id": "0d49256644b963208cb8db044a3ebbe7",
            "_VaccinationAppointment__patient_id": "57c811e5-3f5a-4a89-bbb8-11c0464d53e6",
            "_VaccinationAppointment__phone_number": "+34123456789",
            "_VaccinationAppointment__issued_at": 1646697600.0,
            "_VaccinationAppointment__appointment_date": "2030-12-01",
        ...
        value = my_manager.vaccine_patient\
                ("2c8c5d3bd35ed637d8823344371ae9c64291bb9510001ee96016dc255eb74f70")
    ...
    def test_vaccine_patient_no_date(self):
        ...
        with self.assertRaises(VaccineManagementException) as context_manager:
            my_manager.vaccine_patient(
                "627e4c286ea8bfd9152756b01349cb37ff60e05d10c81bf48cf0f574a04ab6ba")
    ...
    def test_vaccine_patient_no_store_date(self):
        ...
        with self.assertRaises(VaccineManagementException) as context_manager:
            my_manager.vaccine_patient(
                "bb10751120bbc7b092758dcbe846ecd5950be6cbafeec980f439bc97b5989aa0")
